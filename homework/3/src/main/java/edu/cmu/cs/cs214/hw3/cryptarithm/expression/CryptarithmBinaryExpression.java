...
public class CryptarithmBinaryExpression implements CryptarithmExpression {
    ...
    /** This expressions first (left hand) operand. */
    private final CryptarithmExpression operand1;

    /** This expression's second (right hand) */
     ...
     * */
    public CryptarithmBinaryExpression(CryptarithmOperator operator, CryptarithmExpression operand1, CryptarithmExpression operand2) {
